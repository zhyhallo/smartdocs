...
### 4. Тестування Cookie Consent

Cookie banner з'являється автоматично через 1 секунду після завантаження, якщо користувач ще не дав згоду.

**Для тестування cookie banner:**
- Щоб скинути cookie згоду: натисніть **Ctrl+Shift+C** в режимі розробки
- Або видаліть ключ `cookie-consent` з localStorage браузера
