...
const translations = {
  uk: {
    ...
    'faq.q3': 'Які способи оплати доступні?',
    'faq.a3': 'Приймаємо оплату банківським переказом та електронними платежами.',
    'faq.q4': 'Скільки часу займає впровадження?',
    'faq.a4': 'Зазвичай впровадження займає від 1 до 3 робочих днів.',
    ...
    'privacy.contact.intro': 'Якщ�� у вас є питання щодо цієї Політики конфіденційності або ви хочете реалізувати свої права щодо персональних даних, зверніться д�� нас:',
  ...
  pl: {
    ...
    'faq.q3': 'Jakie sposoby płatności są dostępne?',
    'faq.a3': 'Przyjmujemy płatności przelewem bankowym i płatności elektroniczne.',
    'faq.q4': 'Ile czasu zajmuje wdrożenie?',
    'faq.a4': 'Zazwyczaj wdrożenie zajmuje od 1 do 3 dni roboczych.',
  ...
  ru: {
    ...
    'product.benefits.reliability.desc': 'Стабильная ра��ота даже при высоких нагрузках',
    ...
    'faq.a3': 'Принимаем оплату банковским переводом и электронными платежами.',
    'faq.q4': 'Сколько времени занимает внедрение?',
    'faq.a4': 'Обычно внедрение занимает от 1 до 3 рабочих дней.',
    ...
    'contacts.schedule.title': '��ежим работы',
